...
export interface ApiTaskTask extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    bol_id: Schema.Attribute.String;
    bol_number: Schema.Attribute.String;
    cargo_description: Schema.Attribute.Text;
    consignee_address: Schema.Attribute.String;
    consignee_name: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> &
      Schema.Attribute.Private;
    creation_place: Schema.Attribute.String;
    ...
    order_status: Schema.Attribute.Enumeration<
      ["ready", "reject", "pending", "completed", "new"]
    >;
    pickup_date: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    quality: Schema.Attribute.String;
    shipper_address: Schema.Attribute.String;
    shipper_name: Schema.Attribute.String;
